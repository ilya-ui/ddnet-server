...
// client
MACRO_CONFIG_INT(ClRainbowPlayer, cl_rainbow_player, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable rainbow player color")
MACRO_CONFIG_INT(ClRainbowTrail, cl_rainbow_trail, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable rainbow trail")
MACRO_CONFIG_INT(ClShowRussia456, cl_show_russia_456, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show everyone as Russia 456")
MACRO_CONFIG_INT(ClAimbot, cl_aimbot, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable aimbot")
MACRO_CONFIG_INT(ClAimbotRange, cl_aimbot_range, 800, 100, 2000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Aimbot range")
MACRO_CONFIG_INT(ClAimbotOnlyHook, cl_aimbot_only_hook, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Aimbot only when hook is pressed")
MACRO_CONFIG_INT(ClAimbotShowRange, cl_aimbot_show_range, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Show aimbot range lines")
MACRO_CONFIG_INT(ClAutoFight, cl_autofight, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Enable super auto fighting")
MACRO_CONFIG_INT(ClAutoFightRange, cl_autofight_range, 800, 200, 2000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Auto fight target range")
MACRO_CONFIG_INT(ClAutoFightAvoidFreeze, cl_autofight_avoid_freeze, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Avoid stepping into freeze tiles")
MACRO_CONFIG_INT(ClAutoFightFreezeSearch, cl_autofight_freeze_search, 320, 64, 800, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Search radius for nearest freeze tile")
